...
|5|2026/5/19|課題・プロンプト修正機能を課題編集機能とプロンプト修正機能に分離|樋田|
...
**概要**：教師が課題ごとのルーブリック・プロンプトを調整し、AI評価の精度を向上させる機能
...
- **共通プロンプト（課題内容・ルーブリック・プロンプト）の修正**
  - 教師は以下3つの構成要素を修正できる：
    - **課題内容**：課題の説明、目標、実装すべき機能、制約条件など
    - **ルーブリック**：評価観点と各レベルの評価基準
...
- **揺らぎ項目の生成と確認**
  ...
  - システムは修正された共通プロンプト、ルーブリック、課題情報をAIに送信する
  - AIは評価の揺らぎ（解釈が複数に分かれやすい評価項目）を抽出して返す
  - システムが抽出された揺らぎ項目を教師に提示する

- **揺らぎ項目への対応記述**
  - 教師はAIが抽出した各揺らぎ項目について、どのように評価するか（評価基準の詳細化）を記述できる
  - 記述欄は項目ごとに用意される
