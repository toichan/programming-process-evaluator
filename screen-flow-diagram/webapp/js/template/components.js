          ...
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu border-0 shadow-lg" aria-labelledby="tasksDropdown">
                <li><a class="dropdown-item d-flex align-items-center" href="#"><span class="badge bg-success me-2">済</span>変数とデータ型</a></li>
                <li><a class="dropdown-item d-flex align-items-center" href="#"><span class="badge bg-warning me-2">中</span>条件分岐</a></li>
                <li><a class="dropdown-item d-flex align-items-center" href="#"><span class="badge bg-danger me-2">未</span>繰り返し処理</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item text-primary fw-semibold" href="#">全ての課題を見る</a></li>
              </ul>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center" href="#">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center" href="#">
                <svg class="me-1" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <path d="M5 5H3.5A1.5 1.5 0 0 0 2 6.5v7A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5v-7A1.5 1.5 0 0 0 12.5 5H11v2h1.5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .5-.5H5V5z"/>
                  <path d="M8 7.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5z"/>
                </svg>
                アンケート
              </a>
            </li>
