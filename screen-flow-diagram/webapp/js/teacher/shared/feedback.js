/**
 * Shared feedback helpers for teacher pages.
 *
 * Use this file when a teacher page needs one of the following UI patterns:
 * - showToast: 保存完了、生成完了、更新完了などの軽い完了通知
 * - showInlineAlert: 入力不足、保存失敗、実行失敗、注意喚起
 * - showConfirmDialog: 送信前確認、入力リセット確認、実行前の最終確認
 * - showDangerDialog: 削除、一括反映、取り消せない更新、影響範囲が大きい操作
 *
...
(function() {
   ...
   * Examples: 共通プロンプトを保存しました、評価例を生成しました、再評価を開始しました。
   */
   ...
   * Examples: 課題を選択してください、保存に失敗しました、対象の生徒がいません。
   */
   ...
   * Examples: 再評価を実行する前、入力内容をリセットする前、保存前に対象を確認したい時。
   ...
   * Examples: データ削除、一括反映、取り消せない更新、複数生徒への再評価確定。
   */
