      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center" href="../exercise/exercise.html">
                <svg class="me-1" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                  <path d="M2.5 1A1.5 1.5 0 0 0 1 2.5v11A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-11A1.5 1.5 0 0 0 13.5 1h-11zM2 2.5a.5.5 0 0 1 .5-.5H7v12H2.5a.5.5 0 0 1-.5-.5v-11zm6 11.5V2h5.5a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-.5.5H8z"/>
                  <path d="M10.25 5.5a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 0 1.5H11a.75.75 0 0 1-.75-.75zm0 2.5a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 0 1.5H11a.75.75 0 0 1-.75-.75zm0 2.5a.75.75 0 0 1 .75-.75h1a.75.75 0 0 1 0 1.5h-1a.75.75 0 0 1-.75-.75z"/>
                </svg>
                授業演習
              </a>
            </li>
